...
export default function NavBar() {
  ...
  const navBarContent = [
    { to: "/products/category/love", label: "Love" },
    { to: "/products/category/magic", label: "Magic" },
    { to: "/products/category/action", label: "Action" },
    { to: "/products/category/horror", label: "Horror" },
    { to: "/products/category/history", label: "History" },
    { to: "/products/category/philosophy", label: "Philosophy" },
  ];
